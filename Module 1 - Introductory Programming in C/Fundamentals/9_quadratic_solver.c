...
int main (void)
{
    ...
    for (testcount = 1; testcount <= 400; testcount++)
    {
        ...
        else // This code block runs when a is non-zero.
        {
            ...
            if (/* TODO: TASK 2: INSERT CONDITION HERE*/ ) // when there is no solution
            ...
            else if ( /* TODO: TASK 3: INSERT CONDITION HERE */ )// when there is 1 solution
            {
