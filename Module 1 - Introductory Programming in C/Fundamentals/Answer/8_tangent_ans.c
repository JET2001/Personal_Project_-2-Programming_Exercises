...
int main(void)
{
    ...
    while (valid == 1 && testcount <= 400)
    {
        ...
        //STEP 1: Store the value of sin(x) in the variable you declared for sine.
        sine_ = sine(x);
        
        
        //STEP 2: Store the value of cos(x) in the variable you declared for cosine.
        cosine_ = cosine(x);
        
        
        //STEP 3: Store the value of tan(x) in the variable you declared for tangent,
        // do this using the variables sine and cosine ONLY.
        tangent = sine_ / cosine_;
